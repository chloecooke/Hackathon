import { BufferGeometry, Color, FileLoader, Float32BufferAttribute, Group, LineBasicMaterial, LineSegments, Loader, Material, Mesh, MeshPhongMaterial, Points, PointsMaterial, SRGBColorSpace, Vector3 } from "./three.module-CnYFkb82.js";
	...
	const state = {
		...
		startObject: function(name, fromDeclaration) {
			...
			this.object = {
				...
				materials: [],
				smooth: true,
				startMaterial: function(name$1, libraries) {
