  ...
  return (
    <Router>
      ...
      <Routes>
            ...
            <section id="home" className="hero-section">
              <div className="container">
                <header className="header">
                  <h1 className="title">Welcome to AZSpace</h1>
                  <p className="subtitle">Exploring the Future of Interactive Web Experiences</p>
                </header>
                ...
                <main className="main-content">
                  <div className="feature-grid">
                    ...
                    <div className="feature-card">
                      <div className="feature-icon">✨</div>
                      <h3>Interactive</h3>
                      <p>Powered by Three.js for stunning 3D visualizations</p>
                    </div>
        ...
        <Route path="/azduoshield" element={
          <div className="page-wrapper">
            {/* Hero Section */}
            <section className="duoshield-hero">
              <div className="container">
